...
import { EstiLogo } from "@/components/branding/EstiLogo";
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-stone-50 via-white to-slate-50 overflow-hidden relative">
        {/* Subtle background texture - pointer-events-none so it doesn't block clicks */}
    ...
    >
      <div className="text-center max-w-5xl">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <EstiLogo variant="full" size="xxl" animated={false} className="mx-auto" />
        </motion.div>
...
// Presentation Section with BIGGER image slideshow
      ...
      <div className="w-full max-w-[1400px]">
        ...
        <div className="mt-6 flex items-center justify-between px-2">
          ...
          <Button
            ...
            className={cn(
              "text-xs gap-2",
              autoPlay && "bg-slate-100 border-slate-300"
            )}
          >
            ...
            >
              <div className="flex items-center gap-2">
                <Button
                  ...
                  size="icon"
                  onClick={onPause}
                  className="text-white hover:bg-white/20 backdrop-blur-sm bg-black/40"
                >
...
// Stats Section - Sophisticated data visualization
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full">
        ...
        {/* Stats grid - land-book.com inspired */}
...
// Value Proposition Section - Modern card layout
    ...
    >
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          ...
          <Button onClick={onNext} className="gap-2 bg-slate-900 hover:bg-slate-800 text-white shadow-xl">
            Get Early Access
            <ArrowRight className="w-4 h-4" />
          </Button>
        </motion.div>
  ...
  return (
    ...
    >
      <div className="text-center max-w-5xl">
        ...
        {/* CTA Cards instead of just buttons */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <motion.div
            ...
            className="relative bg-slate-900 rounded-2xl p-8 shadow-2xl shadow-slate-400/30 hover:shadow-slate-400/50 cursor-pointer group"
          ...
          <motion.div
            whileHover={{ scale: 1.02, y: -4 }}
            transition={{ duration: 0.2 }}
            className="relative bg-white border-2 border-slate-200 rounded-2xl p-8 shadow-xl shadow-slate-200/50 hover:shadow-slate-300/70 cursor-pointer group"
            onClick={() => window.location.href = "/"}
          >
            <div className="text-left">
              <div className="text-slate-500 text-sm font-semibold mb-2 tracking-wider">STANDARD</div>
              <h3 className="text-3xl font-bold text-slate-900 mb-3">Try It Free</h3>
              <p className="text-slate-600 mb-6 text-base">
                Test Esti with your own drawings. No credit card. No commitment.
              </p>
              <div className="flex items-center justify-between">
                <span className="text-2xl font-bold text-slate-900">$0 to start</span>
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <Button variant="ghost" onClick={onPrev} className="text-slate-400 hover:text-slate-600">
